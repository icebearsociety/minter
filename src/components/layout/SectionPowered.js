...
const SectionPowered = () => {
  return (
    <section className="section-powered">
      <video className="powered-gif" autoPlay loop muted playsInline>
      ...
      <img className="powered-layer1 img-fluid" src={poweredLayer1} alt="" />
      <picture>
      ...
      <img className="powered-layer2 img-fluid" src={poweredLayer2} alt="" />
    </section>
  );
};
