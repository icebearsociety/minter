...
const SectionTeam = () => {
  return (
    <section className="section-team" id="team">
      <img
        className="img-fluid teeam-top-layer"
        width="100%"
        object-fit="cover"
        src={topLayer}
        alt=""
      ...
      <div class="container">
        <div class="row team-row">
          <div class="col-md-2 col-sm-6 team-wrap">
            <div class="team-member text-center">
              ...
              <br></br>
              <span>
                <a href="https://www.instagram.com/gunnelly/">
                  <svg
                ...
                &emsp;
                <a href="https://twitter.com/RohitGunnelly">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
          ...
          <div class="col-md-2 col-sm-6 team-wrap">
            <div class="team-member text-center">
              ...
              <span className="fi-text">Outreach Management</span>
              <br></br>
              <a href="https://www.instagram.com/gehareddyy/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              &emsp;
              <a href="https://twitter.com/Geha_reddy">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
          ...
          <div class="col-md-2 col-sm-6 team-wrap">
            <div class="team-member last text-center">
              ...
              <span className="fi-text">Digital Art Creator</span>
              <br></br>
              <a href="https://www.instagram.com/cvrrytrash/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              &emsp;
              <a href="https://twitter.com/cvrrytrash">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
          ...
          <div class="col-md-2 col-sm-6 team-wrap">
            <div class="team-member last text-center">
              ...
              &emsp;
              <a href="https://twitter.com/RahulArepaka">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
          ...
          <div class="col-md-2 col-sm-6 team-wrap">
            <div class="team-member last text-center">
              ...
              <span className="fi-text">Community Manager</span>
              <br></br>
              <a href="https://www.instagram.com/satvik_kondra/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              &emsp;
              <a href="https://twitter.com/Satvik7555">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
          ...
          <div class="col-md-2 col-sm-6 team-wrap">
            <div class="team-member last text-center">
              ...
              <span className="fi-text">Web3 Dev | Marketing</span>
              <br></br>
              <a href="https://www.instagram.com/_aaryansharma/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              &emsp;
              <a href="https://twitter.com/__aaryansharma">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
        ...
        <br></br>
        <div className="heading-container">
          <h2 className="heading-secondary text-gradient">Hype Bears</h2>
        </div>
        <div className="pakaPaka">
          <div class="col-md-2 col-sm-2 team-wrap hypeBear">
            <div class="team-member text-center">
              ...
              <h6 class="fi1-text">Sidhant B Patil</h6>
              <span className="fi-text">Hype Bear</span>
              <br></br>
              <span>
                <a href="https://www.instagram.com/sidhant0608/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                &emsp;
                <a href="https://twitter.com/Sidhant_Patil1?t=g_YjeoDS5RxEIlEvn3mdEg&s=08">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
          ...
          <div class="col-md-2 col-sm-2 team-wrap hypeBear">
            <div class="team-member last text-center">
              ...
              <h6 class="fi1-text">Abdul Rafey</h6>
              <span className="fi-text">Hype Bear</span>
              <br></br>
              <a href="https://www.instagram.com/abdul.rafey.5815/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              &emsp;
              <a href="https://twitter.com/abdulrafey9?s=11">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
