...
import snowMp4 from "../../assets/images/simple_c.mp4";
import snowWeb from "../../assets/images/simple.webm";
import snowMp4Small from "../../assets/images/simple_small_c.mp4";
import snowWebSmall from "../../assets/images/simple_small.webm";
    ...
    <section className="hero">
      <video autoPlay loop muted playsInline className="snow-gif">
        ...
        <MediaQuery minWidth={768}>
          <source src={snowWeb} type="video/webm" />
      ...
      <div className="wavy wavy-4">
        <img className="img-fluid" src={wavyImg4} alt="pattern" />
      </div>
    </section>
  );
};
